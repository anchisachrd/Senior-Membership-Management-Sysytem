...
function EditInfoPage1({ values, errors, touched, setFieldValue }) {
...
// =============== STEP 2: Heir Page ===============
function EditInfoPage2({ values, setFieldValue, errors, touched }) {
  const handleFileChange = (e) => {
    const { name, files } = e.target;
    setFieldValue(name, files[0]);
  };
                ...
                <div className="2xl:flex">
                  <div className="ibm-plex-sans-thai-medium">
                    ...
                    <div className="text-center text-3xl text-black mb-8 font-bold">
                      แก้ไขข้อมูลการลงทะเบียนชมรมผู้สูงอายุ
                    </div>
