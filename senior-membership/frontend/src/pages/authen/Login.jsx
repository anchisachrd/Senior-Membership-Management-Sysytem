          ...
          <div class="2xl:flex">
            <div className='ibm-plex-sans-thai-medium'>
              <div class="p-8 bg-gray-50 overflow-hidden rounded-xl shadow-xl">
                <div class="text-center text-3xl text-black mt-8 mb-8 font-bold">เข้าสู่ระบบชมรมผู้สูงอายุ</div>
                ...
                <div class="grid gap-6 md:grid-cols-1 place-items-center">
                  ...
                  <div>
                    <Link to='/register' class="inline-flex text-sm items-center text-gray-600 hover:underline">
